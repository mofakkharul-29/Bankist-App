...
btnLogin.addEventListener("click", function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    // if credentials are correct make UI visible for user
...
btnLoan.addEventListener("click", function (e) {
  e.preventDefault();
  const amount = Math.floor(inputLoanAmount.value); //Number(inputLoanAmount.value);
  if (amount <= 0) {
...
btnClose.addEventListener("click", function (e) {
  ...
  // clearing input field of cloes account input box
